...
namespace DMR.Helpers
{
    class Class1
    {
        ...
        public ushort WordsToInt(ushort wrdH, ushort wrdL)
        {
            ushort iTemp;
            iTemp = wrdH;
            iTemp <<= 16;
            iTemp = (ushort)(iTemp & 0xffff0000);
            iTemp |= wrdL;
            return iTemp;
        }
        ...
        public object CodeData(ARM.IWhichData iWhichData, string DataToWrite, byte[] Key)
        {
            ...
            bte = Encoding.Default.GetBytes(DataToWrite);
        ...
        public byte[] CreateUserKey(string str, byte[] Key)
        {
            ...
            {
                if (str.Length != 32)
                    MessageBox.Show("UserKey Must be 32 Character!");
                else
                {
